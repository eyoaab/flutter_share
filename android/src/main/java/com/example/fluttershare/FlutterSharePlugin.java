...
public class FlutterSharePlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        methodChannel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_share");
    ...
    private void share(MethodCall call, @NonNull Result result) {
        try {
            ...
            Log.e("FlutterShare", "Error sharing text: " + ex.getMessage());
            result.error("FlutterShare: Error sharing text", ex.getMessage(), null);
        }
    }

    private void shareFile(MethodCall call, @NonNull Result result) {
        try {
            String title = call.argument("title");
            String text = call.argument("text");
            ...
            if (filePath == null || filePath.isEmpty()) {
                Log.e("FlutterShare", "FilePath cannot be null or empty for sharing file");
            ...
            Log.e("FlutterShare", "Error sharing file: " + ex.getMessage());
            result.error("FlutterShare: Error sharing file", ex.getMessage(), null);
        }
    }
}